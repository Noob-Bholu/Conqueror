...
from NoobBholu import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, DONATION_LINK, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from NoobBholu.modules import ALL_MODULES
from NoobBholu.modules.helper_funcs.chat_status import is_user_admin
from NoobBholu.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("NoobBholu.modules." + module_name)
